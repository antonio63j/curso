...
@Component({
  selector: 'app-doc-fuentes-ejdirectivangif',
  template: `
       <doc-fuentes [items]="items"></doc-fuentes>
  `
})

export class DocEjDirectivangifComponent implements OnInit {
  items: any[] = [
    { title: 'Template',
      code: '',
      file: 'assets/app/ejdirectivangif.component.html'
    },
    { title: 'Componente',
      code: '',
      file: 'assets/app/ejdirectivangif.component.ts',
      aread: 'assets/app/doc-directivangif.html',
      codeAread: ''
    }
  ];
